 ...
 * Question Upvote.
 */
public class ReplyDateComparator implements Comparator<Reply> {
	/**
	 * @param a
	 *            : left hand side Reply
	 * @param b
	 *            : right hand side Reply
	 * @return -1 if left hand side Reply's Date is higher than the right
	 *         hand side Reply's Date 1 otherwise.
	 */
	@Override
