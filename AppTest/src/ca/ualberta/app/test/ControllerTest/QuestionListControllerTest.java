...
public class QuestionListControllerTest extends TestCase {
	...
	Question q1 = new Question(questionString, userId, titleString,
			imageByteArray);
	Question q2 = new Question(questionString, userId, titleString,
			imageByteArray);
	...
	public void testAddReplyToQ() {
		...
		Reply r = new Reply(ReplyString, userId);
		// add Question
		qlc.addQuestion(q1);
	...
	public void testAddReplyToA() {
		...
		Answer a = new Answer(AnswerString, userId, imageByteArray);
		Reply r = new Reply(ReplyString, userId);
		// add Question
		qlc.addQuestion(q1);
