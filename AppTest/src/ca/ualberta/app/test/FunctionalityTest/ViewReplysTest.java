...
public class ViewReplysTest extends TestCase {
	public void testViewReplysOffline() {
		...
		Reply reply_A = new Reply(replyString, userId);
		Reply reply_B = new Reply(replyString, userId);
	...
	public void testViewReplysOnline() {
		...
		// String titleString = "title";
		// String imageByteArray = null;
		// Question question = new Question(questionString, userName,
		// titleString,
		// imageByteArray);
		...
		//
		// // add one Reply to Question and add the other Reply to Answer, then
		// add
		...
		//
		// // check the result
		// assertTrue("User cannot view QuestionReplys", replyList_Q.size() ==
		// 1);
		// assertTrue("User cannot view AnswerReplys", replyList_A.size() == 1);
		// assertEquals(reply_A.getContent(), result_A.getContent());
