...
public class ScoreComparatorTest extends
	 ...
	 * two Questions and a ScoreComparator. Next, upvote one Question, so the
	 * Score is different. Then, check if the compare method returns the correct
	 * value when Questions with different scores. Methods tested: compare
	 * 
	 * @throws Exception
	 */
	public void testCompare() throws Exception {
		...
		Question question1 = new Question("TestContent1", userId, "TestTitle1",
				null);
		Question question2 = new Question("TestContent2", userId, "TestTitle2",
				null);
