...
public class DateComparatorTest extends
	 ...
	 * two Questions and a DateComparator with a center location. Then, check if
	 * the compare method returns the correct value when Questions created at
	 * different time are passed in. Methods tested: compare
	 * 
	 * @throws Exception
	 */
