...
public class PictureComparatorTest extends
	 ...
	 * two Questions and a PictureComparator. Then, check if the compare method
	 * returns the correct value when Questions with or without a picture are
	 * passed in. Methods tested: compare
	 * 
	 * @throws Exception
	 */
	public void testCompare() throws Exception {
		...
		Question question1 = new Question("TestContent1", userId - 0,
				"TestTitle1", null);
		Question question2 = new Question("TestContent2", userId - 1,
				"TestTitle2", null);
		Question question3 = new Question("TestContent3", userId - 2,
				"TestTitle3", imageString);
		Question question4 = new Question("TestContent4", userId - 3,
