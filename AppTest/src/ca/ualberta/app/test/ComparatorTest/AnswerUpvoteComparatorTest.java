...
public class AnswerUpvoteComparatorTest extends
	...
	/**
	 * Test whether the compare method returns the correct value. First, create
	 * two Questions , two Answers and a AnswerUpvoteComparator. Next, upvote
	 * one Answer. Then, check if the compare method returns the correct value
	 * when Questions with different number of upvotes. Methods tested: compare
	 * 
	 * @throws Exception
	 */
	public void testCompare() throws Exception {
		AnswerUpvoteComparator answerUpvoteComparator = new AnswerUpvoteComparator();
		Question question1 = new Question("TestContent1", (long) 123,
				"TestTitle1", null);
		Question question2 = new Question("TestContent2", (long) 123,
				"TestTitle2", null);
		Answer answer1 = new Answer("TestAnswerContent1", (long) 123, null);
		Answer answer2 = new Answer("TestAnswerContent2", (long) 123, null);
