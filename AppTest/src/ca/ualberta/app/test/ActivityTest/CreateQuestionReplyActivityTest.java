...
public class CreateQuestionReplyActivityTest extends
		ActivityInstrumentationTestCase2<CreateQuestionReplyActivity> {
	CreateQuestionReplyActivity mActivity;
	EditText content;
	ImageView picture;
	RadioButton submit;
	RadioButton cancel;
	 ...
	 * Constructor
	 */
	public CreateQuestionReplyActivityTest() {
		super(CreateQuestionReplyActivity.class);
	}
	...
	protected void setUp() throws Exception {
		...
		content = (EditText) mActivity
				.findViewById(R.id.question_reply_content_editText);
		submit = (RadioButton) mActivity
				.findViewById(R.id.submit_reply_button);
		cancel = (RadioButton) mActivity
				.findViewById(R.id.cancel_reply_button);
	}
