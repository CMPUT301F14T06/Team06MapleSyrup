...
public class LoginActivityTest extends
	...
	protected void setUp() throws Exception {
		...
		content = (EditText) mActivity.findViewById(R.id.username_editText);
		login = (RadioButton) mActivity.findViewById(R.id.login_button);
		cancel = (RadioButton) mActivity.findViewById(R.id.login_cancel_button);
	}
