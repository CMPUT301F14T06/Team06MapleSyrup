...
public class QuestionListControllerTest extends TestCase {
    ...
    public void testAddQuestion(){
    	...
    	assertTrue("no question in question list", qlc.getQuestionList().size()==1);
    	assertTrue("q1 was not added",qlc.getQuestionList().getArrayList().contains(q1));
    }
    ...
    public void testAddReplyToA(){
		...
		assertTrue("no reply add to answer",qlc.getQuestionList().getReplysOfAnswer(0, 0).contains(r));
	 }
