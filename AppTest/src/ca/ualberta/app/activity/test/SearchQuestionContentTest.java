...
//		questionListController.addAll(questionListManager.searchQuestions(questionString, null,null));	
//		
...
//		
//		questionListController.clear();
//		questionListController.addAll(questionListManager.searchQuestions(titleString, null,null));	
//		
//		if (questionListController.size() == 1){
//			result = questionListController.getQuestion(0);
//		}
...
//		
//		questionListController.clear();
//		questionListController.addAll(questionListManager.searchQuestions(userName, null, null));	
//		
//		if (questionListController.size() == 1){
//			result = questionListController.getQuestion(0);
//		}
